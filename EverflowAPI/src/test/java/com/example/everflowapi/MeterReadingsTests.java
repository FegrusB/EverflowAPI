...
public class MeterReadingsTests {
    ...
    @Test
    void csvToMeterReadingTestPerfectSet(){
        ...
        Assertions.assertEquals(sampleReading, result.getData().get(0));
    ...
    @Test
    void csvToMeterReadingTestImperfectSet(){
        ...
        Assertions.assertEquals(sampleReading, result.getData().get(157));
