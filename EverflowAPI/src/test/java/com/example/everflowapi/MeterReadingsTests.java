...
public class MeterReadingsTests {
    ...
    void csvToMeterReadingTestPerfectSet() throws IOException {
        ...
        MeterReading sampleReading = new MeterReading("3024422755W10","08M161403", Timestamp.valueOf("2017-12-17 00:00:00"),3532,false,false,false,"C","z3024422755");

        InputStream in = getClass().getResourceAsStream("/Data/test1.csv");
        BufferedReader reader = new BufferedReader(new InputStreamReader(in));

        CSVHelper.CSVResult result = CSVHelper.csvToMeterReading(in);
    ...
    void csvToMeterReadingTestImperfectSet() throws IOException {
        ...
        MeterReading sampleReading = new MeterReading("3022317867W11","88129662",Timestamp.valueOf("2022-08-15 00:00:00"),22000,false,true,false,"0","3022317867");
